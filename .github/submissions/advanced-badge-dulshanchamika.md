...
![Screenshot showing successful workflow run](screenshots/task1-1.png)(screenshots/task1-2.png)

### Task 2: Push Trigger
![Screenshot showing workflow triggered automatically on push](screenshots/task2-1.png)(screenshots/task2-2.png)

### Task 3: Local Tests
![Screenshot showing npm test output - all passing](screenshots/task3.png)(screenshots/task3-2.png)(screenshots/task3-1.png)

### Task 4: Create a Custom Workflow
![Task 4 - Custom Workflow](screenshots/task4-1.png)(screenshots/task4-2.png)

### Task 5: Add Environment Variables
![Task 5 - Env Variables](screenshots/task5-1.png)(screenshots/task5-2.png)(screenshots/task5-3.png)

### Task 6: Use GitHub Secrets
![Task 6 - GitHub Secrets](screenshots/task6-1.png)(screenshots/task6-2.png)

### Task 7: Matrix Testing
![Task 7 - Matrix Testing](screenshots/task7-1.png)(screenshots/task7-2.png)

### Task 8: Upload and Download Artifacts
![Task 8 - Artifacts](screenshots/task8-1.png)(screenshots/task8-2.png)
